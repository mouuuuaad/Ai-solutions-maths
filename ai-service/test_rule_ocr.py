...
import asyncio
from app.services.rule_based_ocr import RuleBasedOCR

async def test_rule_ocr():
    """Test the rule-based OCR service"""
    print("🧪 Testing Rule-Based OCR Service")
    print("=" * 50)
    
    ocr_service = RuleBasedOCR()
