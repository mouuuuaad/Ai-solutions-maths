...
import asyncio
from app.services.final_math_ocr import FinalMathOCR

async def test_final_ocr():
    """Test the final math OCR service"""
    print("🧪 Testing Final Math OCR Service")
    print("=" * 50)
    
    ocr_service = FinalMathOCR()
