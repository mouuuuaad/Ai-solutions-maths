...
class PatternBasedOCR:
    def __init__(self):
        # Common OCR patterns and their corrections
    ...
    def extract_text_with_patterns(self, image: Image.Image) -> str:
    ...
    def clean_text_with_patterns(self, text: str) -> str:
        ...
        for wrong, correct in self.pattern_corrections.items():
    ...
    def extract_text_from_canvas(self, canvas_data: str) -> str:
        """Extract text from canvas data using pattern-based approach"""
        try:
            ...
            # Extract text
            text = self.extract_text_with_patterns(processed_image)
    ...
    def test_on_simple_equations(self) -> Dict[str, any]:
        ...
        for equation in test_equations:
            ...
            text = self.extract_text_with_patterns(processed_img)
            cleaned_text = self.clean_text_with_patterns(text)
